...
/** @type {string} */
const CACHE_VERSION = '1750510221|22619094';
/** @type {string} */
const CACHE_PREFIX = 'Flappy_Plane-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'flappy_plane.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["flappy_plane.html","flappy_plane.js","flappy_plane.offline.html","flappy_plane.icon.png","flappy_plane.apple-touch-icon.png","flappy_plane.audio.worklet.js","flappy_plane.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["flappy_plane.wasm","flappy_plane.pck"];
